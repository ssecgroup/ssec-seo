...
<head>
    ...
    <title> SPYGLASS ULTIMATE SEO REPORT By https://github/ssecgroup - {results.get('domain', 'Unknown')}</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class="report-wrapper" id="report-content">
        ...
        <div class="header">
            <div class="header-content">
                <div>
                    <h1> SPYGLASS ULTIMATE SEO REPORT By https://github/ssecgroup </h1>
            ...
            <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 30px;">
                <div>
                    <p style="font-size: 16px; line-height: 1.8; color: #333;">
                        SPYGLASS scanned <strong>{results.get('statistics', {}).get('pages_crawled', 0)} pages</strong> 
        ...
        <!-- Footer -->
        <div class="footer">
            Generated by SPYGLASS Ultimate SEO Engine v0.1.0 | MIT License | Open Source | By ssecgroup_shiyanthan k<br>
    ...
    <script>
        ...
        function downloadPDF() {{
            ...
            const opt = {{
                margin:       0.5,
                filename:     'spyglass_ultimate_report_{results.get('domain', 'scan')}.pdf',
